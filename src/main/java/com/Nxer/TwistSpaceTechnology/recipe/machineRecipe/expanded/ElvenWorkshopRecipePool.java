...
import static vazkii.botania.common.block.ModBlocks.alchemyCatalyst;
...
public class ElvenWorkshopRecipePool  {
    ...
    public static void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), Materials.Quartz.getGems(1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Blocks.glass,1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Items.string,1))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(ModItems.manaResource,4,16))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Items.ender_pearl, 1))
            .fluidInputs(MaterialPool.LiquidMana.getFluidOrGas(1500))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Items.glowstone_dust, 1))
        ...
        //pure daisy recipe
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Items.stick,16,0))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Blocks.stone,16))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(GTUtility.getIntegratedCircuit(1), new ItemStack(Blocks.end_stone,16),new ItemStack(Items.glass_bottle, 16))
