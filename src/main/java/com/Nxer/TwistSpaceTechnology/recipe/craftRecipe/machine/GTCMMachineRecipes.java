    ...
    public static void loadRecipes() {
        ...
        if (Config.Enable_BallLightning) {
            ...
            GTValues.RA
                ...
                .metadata(SCANNING, scanningLV(24 * HOURS))
                .itemInputs(
                    GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.SuperconductorUVBase, 64),
        ...
        if (Config.Enable_LightningSpire){
            GTValues.RA.stdBuilder()
                ...
                .fluidInputs(
                    Materials.Silicon.getMolten(2304)
                )
        ...
        if(Config.Enable_IncompactCyclotron){
            ...
            GTValues.RA
                ...
                .fluidInputs(
                    ...
                    Materials.SuperconductorUVBase.getMolten(144 * 8),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[]{
                ...
                eM_Spacetime.get(4),
                ItemList.Field_Generator_UMV.get(64),
                new Object[]{OrePrefixes.circuit.get(Materials.UMV), 32},
            },
            new FluidStack[]{
